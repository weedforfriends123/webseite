...
const STRAINS = [
  ...
  { key: "gsc", line1: "GIRL SCOUT",  line2: "COOKIES", img: "/pouches/girl-scout-cookies.webp",  flavor: "Minze · Erde · Süße" },
]
...
export function Section01_Hero() {
  ...
  return (
    ...
    <div ref={outerRef} className="h-[100svh] md:h-[480vh] relative">
      <section
        id="hero"
